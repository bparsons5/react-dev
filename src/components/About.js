      ...
      <Col id="about" xs={11} sm={11} md={9} xl={7}>
        <Row id="about-row">
          <Col xs={12} md={8}>
            ...
            <p id='about-resume'>for more skills, checkout out my <a id='about-resume-link' href='https://docs.google.com/document/d/1uGI0c02SQK97FTZHn3qWhFaRsofIdNBMOm7sDcPxfwU/edit?usp=share_link' target='_blank' rel='noreferrer'>resume</a></p>
          </Col>
          <Col xs={6}  md={4}>
